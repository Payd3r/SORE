                                                ...
                                                <div className="flex-1 text-center md:text-left">
                                                    ...
                                                    <div className="flex flex-wrap justify-center md:justify-start gap-3 lg:gap-4">
                                                        <button
                                                            ...
                                                            className="flex-1 max-w-[200px] bg-blue-500 hover:bg-blue-600 text-white font-medium py-2 lg:py-2.5 px-4 lg:px-6 rounded-xl 
                                                        ...
                                                        <button
                                                            ...
                                                            className="flex-1 max-w-[200px] px-4 lg:px-6 py-2 lg:py-2.5 bg-red-500 text-white text-sm lg:text-base font-medium rounded-xl hover:bg-red-600 transition-all duration-200 shadow-sm hover:shadow flex items-center justify-center gap-1.5 lg:gap-2 outline-none focus:outline-none active:outline-none"
                                                        >
