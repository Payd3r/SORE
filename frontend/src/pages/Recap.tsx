...
const Recap: React.FC = () => {
    ...
    return (
        <div className="min-h-screen bg-gray-50 dark:bg-gray-900 text-gray-900 dark:text-white">
            {/* Header Section */}
            <div className="bg-gradient-to-b from-blue-600/10 dark:from-blue-500/10 to-transparent pt-4 pb-8 sm:pt-6 sm:pb-12">
                <div className="max-w-7xl mx-auto px-4 sm:px-6">
                    <h1 className="text-2xl sm:text-3xl font-bold text-gray-900 dark:text-white">Recap</h1>
                    <p className="text-sm sm:text-base text-gray-600 dark:text-gray-400 mt-2">Statistiche e analisi dei vostri ricordi insieme</p>
                </div>
            </div>

            {/* Tab Navigation */}
            <div className="max-w-7xl mx-auto px-4 sm:px-6 -mt-6 pb-8">
                <Tab.Group>
                    ...
                    <Tab.Panels className="mt-4 sm:mt-8 focus:outline-none focus:ring-0 space-y-4 sm:space-y-6">
                        <Tab.Panel className="focus:outline-none focus:ring-0">
                            {/* La vostra storia */}
                            <div className="bg-white/80 dark:bg-gray-800/50 rounded-xl p-4 sm:p-6 backdrop-blur-sm">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-6 mt-4 sm:mt-6">
                                {/* Ricordi per tipo */}
                                <div className="bg-white/80 dark:bg-gray-800/50 rounded-xl p-4 sm:p-6 backdrop-blur-sm md:col-span-2">
