    ...
    <div className="fixed inset-0 z-50 overflow-y-auto">
      ...
      <div className="min-h-screen flex items-center justify-center p-4">
        ...
        <div className="w-full h-screen flex items-center justify-center">
          <div className="relative flex flex-col lg:flex-row bg-white dark:bg-gray-900 rounded-xl overflow-hidden h-[88vh] lg:h-[85vh] w-[92vw] lg:w-fit lg:max-w-[95vw] shadow-2xl">
            {/* Image container */}
            <div className="relative bg-black dark:bg-gray-900 flex items-center justify-center h-[53vh] lg:h-[85vh]">
              {imageError ? (
            ...
            {/* Details panel */}
            <div className="w-full lg:w-[400px] shrink-0 p-3 lg:p-6 flex flex-col bg-white dark:bg-gray-900 border-t lg:border-t-0 lg:border-l border-gray-200 dark:border-gray-800 h-[35vh] lg:h-[85vh]">
              ...
              <div className="flex-1 space-y-2">
                {displayImage.created_by_name && (
                  <div className="flex items-center space-x-2 p-2 bg-gray-50 dark:bg-gray-800/50 rounded-lg">
                    <div className="flex-shrink-0 w-8 h-8 lg:w-10 lg:h-10 rounded-full bg-gradient-to-br from-blue-500 to-blue-600 flex items-center justify-center">
                      <span className="text-sm lg:text-base text-white font-medium">
                        {displayImage.created_by_name.charAt(0).toUpperCase()}
                      </span>
                    </div>
                    <div>
                      <span className="block text-xs lg:text-sm text-gray-500 dark:text-gray-400">Caricata da</span>
                      <span className="block text-sm lg:text-base text-gray-900 dark:text-white font-medium">
                        {displayImage.created_by_name}
                      </span>
                    </div>
                  </div>
                  ...
                  <div className="bg-gray-50 dark:bg-gray-800/50 rounded-lg p-2">
                    <div className="flex items-start space-x-2">
                      ...
                      <div className="flex-1 min-w-0">
                        <span className="block text-xs lg:text-sm text-gray-900 dark:text-white font-medium truncate">
                        ...
                        <a
                          ...
                          className="inline-flex items-center mt-1 text-xs lg:text-sm text-blue-500 hover:text-blue-600 dark:text-blue-400 dark:hover:text-blue-300"
                        >
              ...
              <div className="mt-3 grid grid-cols-2 gap-2">
                <button
                  type="button"
                  className="flex items-center justify-center px-3 py-2 text-xs lg:text-sm font-semibold text-gray-900 dark:text-white bg-gray-100 dark:bg-gray-800 rounded-lg hover:bg-gray-200 dark:hover:bg-gray-700 transition-colors focus:outline-none focus:ring-2 focus:ring-blue-500 dark:focus:ring-blue-400"
                  onClick={() => {
                ...
                >
                  <svg className="w-4 h-4 lg:w-5 lg:h-5 mr-1.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <button
                  ...
                  className={`flex items-center justify-center px-3 py-2 text-xs lg:text-sm font-semibold text-white rounded-lg transition-colors focus:outline-none focus:ring-2 focus:ring-red-500 ${
                    isDeleting 
