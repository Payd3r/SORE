...
import InfoRicordoMobile from './InfoRicordoMobile';
import GalleriaRicordoMobile from './GalleriaRicordoMobile';
import CronologiaRicordoMobile from '../Memory/CronologiaRicordoMobile';
