        ...
        <div className="flex justify-center">
          ...
          <div className="inline-flex items-center rounded-full bg-white/10 p-1 shadow-inner">
            ...
            <button
              ...
              className="flex items-center justify-center gap-1.5 px-4 py-2 rounded-full text-white text-sm font-medium"
            >
            ...
            <button
              ...
              disabled={isDeleting}
              className={`flex items-center justify-center gap-1.5 px-4 py-2 rounded-full text-white text-sm font-medium ${isDeleting ? 'opacity-50' : ''}`}
            >
              <svg className="w-4.5 h-4.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16" />
              </svg>
              <span>{isDeleting ? 'Eliminando...' : 'Elimina'}</span>
            </button>
